...
const VALUES = [
  ...
  {
    title: 'Envío gratis',
    desc: 'En compras mayores a $599. Consulta cobertura y tiempo estimado según tu destino.',
...
export function ProductTrustBar() {
  ...
  return (
    ...
    >
      <div
        className="rr-product-trust__inner"
        style={{maxWidth: '1100px', margin: '0 auto'}}
      >
        {/* ── Headline + CTA garantía ── */}
        <div
          className="rr-product-trust__heading"
          style={{
            textAlign: 'center',
        ...
        {/* ── Cards de valores ── */}
        <div
          className="rr-product-trust__grid"
          style={{
            display: 'grid',
...
function ValueCard({title, desc, to, icon}) {
  ...
  return (
    <div
      className="rr-trust-card rr-ui-card rr-ui-card--interactive"
      style={{
        background: '#fff',
        borderRadius: '1rem',
        padding: '1.5rem',
    ...
    >
      {/* Ícono */}
      <div
        className="rr-ui-icon rr-trust-card__icon"
        style={{
          width: '48px',
          height: '48px',
