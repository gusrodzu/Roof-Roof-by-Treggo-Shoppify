...
export function TextInput({
  ...
  return (
    <div
      className="rr-field-group"
      style={{display: 'flex', flexDirection: 'column', gap: '0.375rem'}}
    >
      {label && (
        <label
          className="rr-field-label"
          style={{fontSize: '0.875rem', fontWeight: 600, color: 'var(--ink)'}}
        >
          {label}
        </label>
      )}
      <div className="rr-field-control" style={{position: 'relative'}}>
        {icon && (
          <span
            style={{
              position: 'absolute',
...
export function Checkbox({label, checked, onChange, ...rest}) {
  return (
    ...
    >
      ...
      {label && (
        <span
          style={{fontSize: '0.9375rem', color: 'var(--ink)', fontWeight: 500}}
        >
          {label}
        </span>
      )}
  ...
  return (
    ...
    >
      <button
        ...
        aria-label={label || 'Cambiar opción'}
