...
export function ProductCard({
  ...
  const hasDiscount =
    compare && price && parseFloat(compare.amount) > parseFloat(price.amount);
  ...
  return (
    <div
      className="rr-product-card rr-design-product-card rr-ui-card"
      style={{
        background: '#fff',
    ...
    >
      ...
      >
        <div
          className="rr-product-card__media"
          style={{
            aspectRatio: '1',
        ...
        >
          ...
          {topBadge && (
            ...
            >
              <Badge tone={topBadge.tone} icon={topBadge.icon}>
                {topBadge.label}
              </Badge>
            </span>
          )}
      ...
      <button
        type="button"
        className="rr-icon-button rr-product-card__favorite"
        onClick={(e) => {
          e.preventDefault();
          onToggleFavorite?.();
        }}
        ...
        style={{
          ...
          justifyContent: 'center',
          cursor: 'pointer',
          color: favorited ? 'var(--danger)' : 'var(--ink)',
          marginTop: '-100%',
      ...
      {/* Info */}
      <div className="rr-product-card__body" style={{padding: '0.75rem'}}>
        {product.vendor && (
          <p
            className="rr-product-card__eyebrow"
            style={{
              fontSize: '0.625rem',
              fontWeight: 800,
              color: 'var(--ink-soft)',
        ...
        >
          <p
            className="rr-product-card__title"
            style={{
              fontSize: '0.8125rem',
              fontWeight: 700,
              color: 'var(--ink)',
        ...
        >
          ...
          >
            <span
              className="rr-product-card__price"
              style={{
                fontSize: '0.9375rem',
                fontWeight: 800,
                color: hasDiscount ? 'var(--danger)' : 'var(--ink)',
              }}
            >
            ...
            {hasDiscount && (
              <span
                className="rr-product-card__compare-price"
                style={{
                  fontSize: '0.6875rem',
                  color: 'var(--ink-muted)',
