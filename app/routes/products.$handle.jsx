...
export async function loader({context, params}) {
  ...
  const [{product}, {products: related}] = await Promise.all([
    ...
    storefront.query(RELATED_PRODUCTS_QUERY, {
      variables: {query: "vendor:'ROOF ROOF'", first: 6},
    }),
  ]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="rr-product-gallery-column">
          {/* Imagen principal */}
          <div
            className="rr-product-media"
            style={{
              borderRadius: '1rem',
              overflow: 'hidden',
              background: '#fff',
          ...
          {images.length > 1 && (
            <div
              className="rr-product-thumbnails"
              style={{
                display: 'flex',
                gap: '0.5rem',
                flexWrap: 'wrap',
          ...
          {/* ── Compra protegida ── */}
          <div
            className="rr-product-assurance-card"
            style={{
              background: '#fff',
              border: '1.5px solid #e8e4dc',
          ...
          >
            ...
            >
              ...
              <svg
                ...
                height="24"
                fill="none"
                aria-labelledby="pi-amex-pdp"
              >
                <title id="pi-amex-pdp">American Express</title>
                <rect
                  x=".5"
                  y=".5"
                  width="37"
              ...
              <svg
                ...
                height="24"
                fill="none"
                aria-labelledby="pi-mc-pdp"
              >
                <title id="pi-mc-pdp">Mastercard</title>
                <rect
                  x=".5"
                  y=".5"
                  width="37"
              ...
              <svg
                ...
                height="24"
                fill="none"
                aria-labelledby="pi-visa-pdp"
              >
                <title id="pi-visa-pdp">Visa</title>
                <rect
                  x=".5"
                  y=".5"
                  width="37"
            ...
            >
              Comprar en nuestra tienda es 100% seguro. Todas tus transacciones
              están protegidas desde el momento en que realizas tu pago hasta
              que recibes tu pedido.
            </p>
          </div>
        </div>

        {/* ── COLUMNA DERECHA: info ── */}
        <div className="rr-product-info-column">
          {/* Vendor + título */}
          <p
            style={{
              fontSize: '0.75rem',
          ...
          {variant.availableForSale ? (
            ...
            >
              ...
              >
                Agotado — sin existencias por el momento
              </span>
            </div>
          )}
              ...
              <div key={option.name} style={{marginBottom: '1rem'}}>
                ...
                <div style={{display: 'flex', flexWrap: 'wrap', gap: '0.5rem'}}>
                  {option.values.map((val) => {
                    ...
                    const isAvailable =
                      matchingVariant?.availableForSale ?? false;
          ...
          <div style={{marginBottom: '1rem'}}>
            <ProductCompareButton product={product} size="lg" fullWidth />
          </div>

          <div className="rr-product-guidance">
            <span className="rr-product-guidance__icon">
              <ExperienceIcon name="ruler" size={23} />
            </span>
            <div>
              <strong>Confirma que sea adecuado para tu espacio</strong>
              <p>
                Compara las dimensiones publicadas con las medidas de tu mascota
                y del lugar donde lo utilizarás.
              </p>
              <div className="rr-product-guidance__links">
                <Link to="/pages/guia-de-tallas">Ver guía de medidas</Link>
                <Link to="/pages/selector-de-productos">Usar selector</Link>
              </div>
            </div>
          </div>
          ...
          {product.descriptionHtml && (
            <div
              className="rr-product-description"
      ...
      {/* ── TRUST BAR ── */}
      <div
        className="rr-product-trust-section"
        style={{background: '#2C1810', padding: '2rem 1.5rem'}}
      >
        <div
          style={{
            maxWidth: '1100px',
          ...
          {[
            {
              ...
              desc: 'Consulta cobertura y tiempo estimado según tu destino.',
            },
            {
              icon: (
                <svg
            ...
            },
            {
              ...
              desc: 'Consulta nuestras políticas y canales de contacto.',
            },
          ].map(({icon, title, desc}) => (
            <div key={title}>
              <div
      ...
      {relatedProducts?.length > 0 && (
        ...
        >
          ...
          <div
            className="rr-related-products-grid"
            style={{
              display: 'grid',
      ...
      >
        <div className="rr-mobile-purchase-bar__price">
          <span>Precio</span>
        ...
        {variant.availableForSale ? (
          ...
          >
            {(fetcher) => (
              <Button
                className="rr-mobile-purchase-bar__button"
                type="submit"
                variant="primary"
                size="lg"
                loading={fetcher.state !== 'idle'}
              >
                {fetcher.state !== 'idle' ? 'Agregando...' : 'Agregar'}
              </Button>
            )}
          </CartForm>
        ) : (
...
function RelatedCard({product: p}) {
  ...
  return (
    <div
      className="rr-related-product-card rr-ui-card"
