...
export async function action({request, context}) {
  ...
  const requestedRedirect =
    formData.get('redirectTo') ?? inputs.redirectTo ?? null;
  const redirectTo =
...
export default function Cart() {
  ...
  return (
    <div
      className="rr-cart-page"
      style={{background: '#f5f7fa', minHeight: '100vh', fontFamily: 'inherit'}}
    >
      {/* Breadcrumb */}
      <div
      ...
      <div
        className="rr-cart-container"
        style={{
          maxWidth: '1100px',
          margin: '0 auto',
          padding: isMobile ? '1.25rem 0' : '2rem 1.5rem',
        }}
      >
        {/* Header */}
        <div
          className="rr-cart-header"
          style={{
            display: 'flex',
            alignItems: 'center',
        ...
        >
          ...
          >
            ...
            {cart?.totalQuantity > 0 && (
              <Badge tone="warning">
                {cart.totalQuantity}{' '}
                {cart.totalQuantity === 1 ? 'artículo' : 'artículos'}
              </Badge>
            )}
          </h1>
          <Link
            ...
            onMouseOver={(e) =>
              (e.currentTarget.style.color = 'var(--brand-cta-hover)')
            }
            onMouseOut={(e) =>
        ...
        {isEmpty ? (
          ...
          >
            ...
            <div
              className="rr-cart-summary-wrap"
              style={{
            ...
            >
              <div
                className="rr-cart-summary-heading"
                style={{
                  background: '#2C1810',
              ...
              <div
                className="rr-cart-summary-card"
                style={{
                  background: '#fff',
                  borderTop: 'none',
                  borderBottom: '1px solid #e8e4dc',
          ...
          >
            {[
              ...
              },
              {
                ...
                desc: 'Tiempo estimado según destino',
              },
              {
                icon: (
                  <svg
              ...
              >
                ...
                <div>
                  ...
                  <p style={{fontSize: '0.75rem', color: '#7a6a62', margin: 0}}>
                    {desc}
                  </p>
                </div>
              </div>
...
function EmptyBowlIllustration() {
  return (
    ...
    >
      ...
      {/* Cuenco exterior */}
      <path
        d="M28 72 Q28 108 80 108 Q132 108 132 72 Z"
        fill="#E8E4DC"
        stroke="#c8b8b0"
        strokeWidth="1.5"
      />
      ...
      <g fill="#F5A623" opacity="0.7">
        <polygon
          points="18,38 19.5,34 21,38 25,38 22,40.5 23,44.5 19.5,42 16,44.5 17,40.5 14,38"
          transform="scale(0.7) translate(10,10)"
        />
        <polygon
          points="18,38 19.5,34 21,38 25,38 22,40.5 23,44.5 19.5,42 16,44.5 17,40.5 14,38"
          transform="scale(0.5) translate(218,4)"
        />
      </g>
